...
namespace DeliverIT.API.Controllers
{
    ...
    public class WareHouseController : ControllerBase
    {
        ...
        {
            if (obj is null || obj.City is null || obj.Country is null || obj.StreetName is null)
            {
        ...
        {
            if (obj is null || obj.City is null || obj.Country is null || obj.StreetName is null || !await ws.WareHouseExists(id))
            {
